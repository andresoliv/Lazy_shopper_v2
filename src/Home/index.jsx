...
class Home extends Component { 
  ...
  render() {
    const { index, currentProduct, handleDislike, handleLike } = this.props;
    // const handleDislikeClick = this.handleDislikeClick;
    // const handleLikeClick = this.handleLikeClick;
    const lazyShopPage = <LazyShopPage index={index} handleDislike={handleDislike} handleLike={handleLike} currentProduct={currentProduct} />;
    return (
      <div className="App">
...
const mapStateToProps = (state, props) => ({
  scrapedLength: state.scrapedLength,
  index: state.index,
...
const mapDispatchToProps = (dispatch) => ({
  handleLike: () => dispatch(handleLike()),
  handleDislike: () => dispatch(handleDislike())
});

const HomeConnect = connect(mapStateToProps, mapDispatchToProps);

export { HomeConnect as Home };
